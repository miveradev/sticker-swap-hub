...
export function StickerCard({ code, name, quantity, onAdd, onRemove, onReset }: StickerCardProps) {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 bg-foreground text-background text-[8px] md:text-[12px] w-4 h-4 md:w-5 md:h-5 rounded-full z-10 font-bold flex items-center justify-center transition-transform duration-200 group-hover:scale-125 select-none">
        {quantity}
      </div>
